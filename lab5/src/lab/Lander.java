...
public class Lander extends JFrame {
    ...
    public Lander() throws IOException {
        configureWindow();
        configureCanvas();
        configureUniverse();
    ...
    private void addImageBackground() {
        TextureLoader t = new TextureLoader("source_folder/moon.jpg", canvas);
    ...
    private TransformGroup getCarGroup() throws IOException {
        Shape3D shape = getModelShape3D("lander", "source_folder/lander.obj");
    ...
    public static void main(String[] args) {
        try {
            Lander window = new Lander();
            LanderAnimation landerMovement = new LanderAnimation(car);
            canvas.addKeyListener(landerMovement);
